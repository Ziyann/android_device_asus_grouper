...
static const unsigned char dmpMemory[DMP_CODE_SIZE] = {
    ...
    0x40, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x06, 0x00, 0x00, 0xB2, 0x6A, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
    ...
    ,
    ...
    ,
...
inv_error_t inv_write_dmp_data(FILE *fd, const unsigned char *dmp, size_t len)
{
    ...
    if (len <= 0) {
        ...
        MPL_LOGE("dmp firmware size to write = %d", len);
    }
    if (fd == NULL) {
    ...
    if (bytesWritten != len) {
        ...
        MPL_LOGE("Bytes written = %d", bytesWritten);
    }
    return result;
}
